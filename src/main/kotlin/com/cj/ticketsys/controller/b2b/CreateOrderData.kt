...
data class CtripCreateOrderBody(
...
data class CtripCreateOrderContact(
        var email: String? = "",
        var intlCode: String? = "",
        var mobile: String? = "",
        var name: String? = "",
...
data class CtripCreateOrderCoupon(
        var amount: Int? = 0,
...
data class CtripCreateOrderBodyItem (
        var PLU: String? = "",
...
data class CtripCreateOrderAdjunction(
        var content: String? = "",
...
data class CtripCreateOrderDeposit(
        var amount: Int? = 0,
        var amountCurrency: String? = "",
        var type: Int? = 0
)

data class CtripCreateOrderExpressDelivery(
...
data class CtripCreateOrderPassenger(
        var ageType: String? = "",
...
data class CtripCreateOrderResponseBody(
...
data class CtripCreateOrderResponseBodyItem(
    var inventorys: List<CtripCreateOrderResponseBodyInventory?>? = listOf(),
    var itemId: String? = ""
)

data class CtripCreateOrderResponseBodyInventory(
    var quantity: Int? = 0,
    var useDate: String? = ""
)

data class CtripCreateOrderResponseBodyVoucher(
    var itemId: String? = "",
